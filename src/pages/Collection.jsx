  ...
  return (
    <div className=' mx-auto !px-0'>
      <div className='flex flex-col sm:flex-row gap-8 mb-16'>
        ...
        <div className='min-w-72 bg-[#8dd7e436] p-4 pt-8 pl-6 lg:pl-12 rounded-r-xl '>
          <ShowSearch />
          <div>
        ...
        <div className='bg-[#8dd7e436] p-4 rounded-l-xl'>
          ...
          <div className='flexCenter flex-wrap gap-4 mt-14 mb-10'>
            ...
            {Array.from({length: totalPages}, (_, index ) => (
              ...
              className={`${currentPage === index + 1 && "!bg-black  text-white"} btn-light !py-1 !px-3`}>
                {index + 1}
              </button>
            ))}
